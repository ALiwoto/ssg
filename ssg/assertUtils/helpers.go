...
// Derived from https://github.com/zeebo/assert originally released under CC0 1.0.
...
func DeepEqual(t testing.TB, a, b any) {
	if !deepEqual(a, b) {
		t.Helper()
		t.Fatalf("%#v != %#v", a, b)
	}
...
func literalConvert(val any) any {
	...
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		...
		return val.Convert(reflect.TypeFor[uint64]()).Uint()
